package net.acidicts.chameleon.screen.custom;
...
public class IncubatorScreen extends HandledScreen<IncubatorScreenHandler> {
    private static final Identifier GUI_TEXTURE =
            Identifier.of(ChameleonMod.MOD_ID, "textures/gui/incubator/incubator.png");
    private static final Identifier ARROW_TEXTURE =
            Identifier.of(ChameleonMod.MOD_ID, "textures/gui/arrow_progress.png");
