package net.acidicts.chameleon.block.entity.custom;

import net.acidicts.chameleon.screen.custom.IncubatorScreenHandler;
import net.fabricmc.fabric.api.screenhandler.v1.ExtendedScreenHandlerFactory;
import net.acidicts.chameleon.block.entity.ImplementedInventory;
...
public class IncubatorBlockEntity extends BlockEntity implements ExtendedScreenHandlerFactory<BlockPos>, ImplementedInventory {
    ...
    public Text getDisplayName() {
        return Text.translatable("block.chameleon_mod.incubator");
    }
    ...
    private void craftItem() {
        ItemStack output = new ItemStack(ModItems.CHAMELEON, 1);
    ...
    private boolean hasRecipe() {
        Item input = ModItems.CHAMELEON_EGG;
        ItemStack output = new ItemStack(ModItems.CHAMELEON, 1);
    ...
    private boolean canInsertItemIntoOutputSlot(ItemStack output) {
        // Must be able to stack with existing output or be empty
        return this.getStack(OUTPUT_SLOT).isEmpty() || this.getStack(OUTPUT_SLOT).isOf(output.getItem());
    }
    ...
    protected void readNbt(NbtCompound nbt, RegistryWrapper.WrapperLookup registryLookup) {
        ...
        maxProgress = nbt.getInt("incubator.max_progress");
